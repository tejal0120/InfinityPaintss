<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartMech.aspx.cs" Inherits="Infinitypaints.CartMech" %>
...
<body>
    ...
    <p>
        ...
        <br />
            ...
            ForeColor="White" Height="54px" Width="191px" />

    &nbsp;<asp:Button ID="Button2" runat="server" onclick="Button1_Click" 
                        Text="Continue Shopping" BackColor="#9933FF" 
            BorderColor="#9933FF" ForeColor="White" Height="53px" Width="194px" />
                    </p>
    </form>
</body>
</html>
