<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Infinitypaints.Cart" %>
...
<nav class="navbar navbar-expand-lg navbar-light">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                EnableModelValidation="True" Height="380px" 
                onrowdeleting="GridView1_RowDeleting1" Width="865px" BackColor="White" 
                        PageSize="5">
                <Columns>
...
<p>
        ...
        BorderColor="#9933FF" ForeColor="White" Height="47px" Width="194px" />
                    &nbsp;
                    <asp:Button ID="Button2" runat="server" onclick="Button1_Click" 
                        Text="Continue Shopping" BackColor="#9933FF" 
        BorderColor="#9933FF" ForeColor="White" Height="47px" 
