...
{
    public partial class Metalfinishes : System.Web.UI.Page
    {
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "addtocart")
            {
                ...
                Response.Redirect("CartMetal.aspx?id=" + e.CommandArgument.ToString() + "&quantity=" + dlist.SelectedItem.ToString());
