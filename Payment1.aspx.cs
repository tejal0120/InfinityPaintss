...
namespace Infinitypaints
{
    public partial class Payment1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Label3.Text = Convert.ToString(Session["Days"] + " Days ");
            lblamount.Text = grandtotal().ToString();
            findorderid();
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                String updatepass = "insert into OrderDetails(orderid,sno,pid,pname,pprice,quantity,dateoforder) values('" + Label1.Text + "'," + dt.Rows[i]["sno"] + "," + dt.Rows[i]["id"] + ",'" + dt.Rows[i]["name"] + "'," + dt.Rows[i]["price"] + "," + dt.Rows[i]["quantity"] + ",'" + Label3.Text + "')";
            ...
            //String a = Convert.ToString(Session["Amount"]);
            cmd.CommandText = "Insert into Payment values('" + Label1.Text + "','" + TextBox1.Text + "','" + b + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
            cmd.Connection = con;
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
