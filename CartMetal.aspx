<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartMetal.aspx.cs" Inherits="Infinitypaints.CartMetal" %>
...
<body>
    ...
    <p>
        ...
        <br />
            ...
            BorderColor="#9933FF" ForeColor="White" Height="55px" Width="192px" />

    &nbsp;<asp:Button ID="Button2" runat="server" onclick="Button1_Click" 
                        Text="Continue Shopping" BackColor="#9933FF" 
            BorderColor="#9933FF" ForeColor="White" Height="54px" 
